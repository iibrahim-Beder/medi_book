...
import 'package:medi_book/features/home/presentation/screens/book_appointment_screen/widgets/radio_button_with_title.dart';
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return RadioButtonWithTitle(
            ...
            onTap: (value) =>
                cubic.selectedPaymentOption(paymentOptionsList[value]),
