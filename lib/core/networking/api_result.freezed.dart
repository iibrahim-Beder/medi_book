...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Failures failures) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(Failures failures)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailureImpl<T> with DiagnosticableTreeMixin implements Failure<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ApiResult<$T>.failure(failures: $failures)';
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final Failures failures) = _$FailureImpl<T>;
